...
static void display_init(void)
{
	...
	//for(i=0, pp=(char *)(SCREEN_ATTR_ADR); i<80*24; i++) {
	//	*pp++ = get98attr(0x17);
	//	pp++;
	//}
	...
	//TODO PC-98		
	for(i=0, pp=(char *)(SCREEN_ATTR_ADR+1); i<TITLE_WIDTH; i++, pp+=2) {
		*pp = 0x81;//get98attr(0x20);
	}
	cprint(0, 0, "      Memtest86  v4.10      ");

	//TODO PC-98		
	//for(i=0, pp=(char *)(SCREEN_ATTR_ADR+1); i<2; i++, pp+=30) {
	//	*pp = get98attr(0xA4);
	//}
	cprint(0, 15, "+");
	...
	//TODO PC-98		
	//for(i=0, pp=(char *)(SCREEN_ATTR_ADR+1+(24 * 160)); i<80; i++, pp+=2) {
	//	*pp = get98attr(0x71);
	//}
}
...
static int cpuspeed(void)
{
	...
	do {
		loops++;
	} while ((inb(0x00) & 0x01) == 0);	// counter#1 no output
